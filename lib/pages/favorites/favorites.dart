...
class _FavoritesState extends State<Favorites> {
  ...
  Future<List<FavoritesList>?> getFavorites() async {
    ...
    var response = await http.get(
      Uri.parse("$BASEURI/favorites/getFavorites/$id"),
      headers: {
    ...
    for (var u in result) {
      FavoritesList user =
          FavoritesList(u["companyName"], u["companyID"], u["companyEmail"]);
  ...
  deleteFavorites(companyID) async {
    ...
    try {
      var response = await http.delete(
        Uri.parse("$BASEURI/favorites/deleteFavorites/$id/$companyID"),
        headers: {
          'Content-type': 'application/json',
          "Accept": "application/json",
        },
